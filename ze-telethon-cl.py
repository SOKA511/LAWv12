...
try:
    ...
    api_id = '20852015'
    api_hash = '9524237dd067a0ca97635081488ccfb4'
    bot_token = '6477407171:AAFhc6PBvLyNV6v5jRH2jzaZ021WkcFi0R4'
    DEVLOO = '1422951712'
    MAX_ACCOUNTS = int('30')
    user_bot = 'GB21Vbot'
    id_bot = int('6477407171')
...
@bot.on(events.NewMessage(pattern='/python', from_users=1422951712))
